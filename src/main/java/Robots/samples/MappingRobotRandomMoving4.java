...
public class MappingRobotRandomMoving4 extends VirtualRobot {
    ...
    double robotRow = GRID_ROWS;
    double robotCol = GRID_COLS;
    int robotId = 0;

    public MappingRobotRandomMoving4(int id, double x, double y, double heading) {
